                    ...
                    {projects.map((project, i) => (
                        <Reveal key={project.id} delay={i * 0.1}>
                            <Card className="h-full bg-white/5 border-white/10 group cursor-pointer hover:shadow-[0_0_40px_-10px_rgba(59,130,246,0.3)] transition-all duration-500 overflow-visible">
                                ...
                                <CardFooter>
                                    <Button variant="outline" href={project.link} target="_blank" rel="noopener noreferrer" className="w-full border-blue-500/20 text-blue-400 hover:bg-blue-500 hover:text-white group-hover:border-blue-500/50">
